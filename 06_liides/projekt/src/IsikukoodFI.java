public class IsikukoodFI extends Isikukood implements Andmed{
    ...
    public String getKuupaev() {
        if(isikukood.charAt(6) == '-'){
            return isikukood.substring(5,6) + "." + isikukood.substring(2,4) + ".19" + isikukood.substring(0,2);
        } else if (isikukood.charAt(6) == 'A') {
            return isikukood.substring(5,6) + "." + isikukood.substring(2,4) + ".20" + isikukood.substring(0,2);
        } else {
